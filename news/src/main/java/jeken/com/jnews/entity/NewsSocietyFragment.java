...
public class NewsSocietyFragment extends BaseFragment implements AdapterView.OnItemClickListener {
    private final int UPDATA_LIST = 1;
//    private final String url = "http://route.showapi.com/109-35";
//    private final String channeId = "5572a108b3cdc86cf39001d4";
//    private final String name = "体育焦点";
...
//        httpHandle.buildReuest();
        ...
        jnewsHandle = new JnewsHandle(getContext(),"society",data);
